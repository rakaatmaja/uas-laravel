<x-admin-layout>
    <main class="w-full flex-grow p-6" id="app">
        ...
        <div class="bg-white overflow-auto" id="app">
                ...
                <tbody class="text-gray-700" id="tableBody">
                    <tr v-for="product in products" :key="product.id_produk">
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">
                            <img class="h-20 w-30" :src="product.gambar_produk" alt="">
                        </td>
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">@{{ product.nama_produk }}</td>
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">@{{ product.desk_produk }}</td>
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">@{{ product.harga_produk }}</td>
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">@{{ product.stok_produk }}</td>
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">
                            @{{ getCategoryName(product.id_kategori) }}
                        </td>
                        <!-- ... (kolom lainnya) ... -->
                        <td class="w-1/7 border border-dark-700 text-left py-3 px-4">
                            <div class="flex items-center">
                                <a :href="'/admin/edit/' + product.id_produk">
